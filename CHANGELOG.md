...
- **Offline-First Engine**: Intelligent synchronization queue for POST requests with connectivity monitoring.
- **Dynamic Persistence**: Simple SQL abstraction via `SqlModel` for custom local data.
- **Bilingual Documentation**: Professional README in both English and Portuguese.
